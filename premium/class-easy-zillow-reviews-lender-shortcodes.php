...
class Easy_Zillow_Reviews_Lender_Shortcodes extends Easy_Zillow_Reviews_Lender{
    ...
    function display_lender_reviews($atts){
        ...
        $lender_reviews_options = get_option('ezrwp_lender_reviews_options'); // Professionals Reviews admin tab settings
        ...
        if( $this -> get_has_reviews() ){
            ...
            // Success
            $output = $this -> layout_lender_reviews($layout, $cols);
        } else {
