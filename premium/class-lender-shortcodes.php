<?php
/*
* Easy Zillow Reviews Lender Shortcodes
*/
if(!class_exists('EasyZillowReviewsLenderShortcodes')){
    
    class EasyZillowReviewsLenderShortcodes extends EasyZillowReviewsLender{
        ...
        function display_lender_reviews($atts){
            ...
            $lender_reviews_options = get_option('ezrwp_lender_reviews_options');
